...
function PageHome() {
  ...
  const calculateKelompokStats = () => {
    ...
    generus.forEach((item) => {
      ...
      // Handle gender data
      const gender = item.jenis_kelamin || "BELUM DIISI";
      kelompokStats[kelompok].gender[gender] =
        (kelompokStats[kelompok].gender[gender] || 0) + 1;
    ...
    Object.keys(kelompokStats).forEach((kelompok) => {
      kelompokStats[kelompok].pendidikan = groupPendidikanData(
        kelompokStats[kelompok].pendidikan
      );
    });
  ...
  const openFilterModal = (filter, type) => {
    ...
    let filtered = [];
    const dataSource = auth?.role?.includes("subscriber")
      ? filteredGenerus
      : generus;
  ...
  useEffect(() => {
    ...
    const fetchGenerus = async () => {
      try {
        ...
        console.error("Error fetching generus:", error.response.data.message);
        ...
        <div className="page-header">
          ...
          <div className="user-info subscriber">
            ...
            <button
              ...
              onClick={() =>
                handleExportData(filteredGenerus, "kelompok", auth?.kelompok)
              }
          ...
          <div className="statistics-section">
            <div className="statistics-header">
              <h2 className="statistics-title">
                📈 Statistik Generus - {auth?.kelompok}
              </h2>
              <button
                className="export-btn small"
                onClick={() =>
                  handleExportStatistics(subscriberStats, auth?.kelompok)
                }
            ...
            <div className="statistics-grid">
              ...
              <div className="stat-card pembinaan">
                ...
                <div className="stat-content">
                  <h3 className="stat-value">
                    {Object.keys(subscriberStats.pembinaan).length}
                  </h3>
                  <p className="stat-label">Jenjang Pembinaan</p>
                  <div className="stat-details">
                    {Object.entries(subscriberStats.pembinaan).map(
                      ([key, value]) => (
                        <div
                          key={key}
                        ...
                        >
                          ...
                          <button
                            ...
                            onClick={(e) => {
                              e.stopPropagation();
                              const filtered = filteredGenerus.filter(
                                (item) => item.jenjang_pembinaan === key
                              );
              ...
              <div className="stat-card pendidikan">
                ...
                <div className="stat-content">
                  <h3 className="stat-value">
                    {Object.keys(subscriberStats.pendidikan).length}
                  </h3>
                  <p className="stat-label">Jenjang Pendidikan</p>
                  <div className="stat-details">
                    {Object.entries(subscriberStats.pendidikan).map(
                      ([key, value]) => (
                        <div
                          key={key}
                          className="stat-detail-row clickable"
                        ...
                        >
                          ...
                          <button
                            ...
                            onClick={(e) => {
                              e.stopPropagation();
                              const categories = pendidikanCategories[key] || [
                                key,
                              ];
                              const filtered = filteredGenerus.filter(
                                (item) => {
                                  const pendidikan = cleanPendidikanData(
              ...
              <div className="stat-card gender">
                ...
                <div className="stat-content">
                  <h3 className="stat-value">
                    {subscriberStats.gender["Laki-laki"] +
                      subscriberStats.gender["Perempuan"]}
                  </h3>
        ...
        {sortedGenerus.length === 0 ? (
          <div className="empty-state">
            ...
            <p className="empty-subtext">
              Data generus akan muncul di sini setelah ditambahkan
            </p>
          </div>
        ) : (
          <div className="generus-list">
            {sortedGenerus.map((item) => (
              <div
                key={item.id}
                className="generus-card"
                onClick={() => goToDetail(item.id)}
              >
                <div className="generus-header">
                  <h3 className="generus-name">
                    {item.nama_lengkap || "Nama belum diisi"}
                  </h3>
                  <span
                    className={`gender-badge ${
                      item.jenis_kelamin === "Perempuan" ? "female" : ""
                    }`}
                  >
                    {item.jenis_kelamin === "Laki-laki" ? "👦" : "👧"}{" "}
                    {item.jenis_kelamin || "Belum diisi"}
                  </span>
                </div>
                ...
                <div className="generus-details">
                  <div className="detail-item">
                    ...
                    <span>
                      Pendidikan: {item.jenjang_pendidikan || "Belum diisi"}
                    </span>
                  </div>
                  <div className="detail-item">
                    <span className="detail-icon">📅</span>
                    <span>
                      TTL: {item.tempat_lahir || "Tempat lahir"},{" "}
                      {item.tanggal_lahir
                ...
                <div className="detail-badges">
                  <span className="detail-badge">
                    📚 {item.jenjang_pembinaan || "Belum diisi"}
                  </span>
                </div>
              ...
              <div className="modal-header">
                ...
                <div className="modal-actions">
                  <button
                    className="export-btn small"
                    onClick={() =>
                      handleExportData(filteredData, filterType, selectedFilter)
                    }
                  >
                    📊 Export Data
                  </button>
                ...
                <div className="modal-generus-list">
                  <div className="generus-list modal-list">
                    {filteredData.map((item) => (
                      <div
                        key={item.id}
                        className="generus-card modal-card"
                        onClick={() => goToDetail(item.id)}
                      >
                        <div className="generus-header">
                          <h3 className="generus-name">
                        ...
                        <div className="generus-details">
                          <div className="detail-item">
                            ...
                            <span>
                              Pendidikan:{" "}
                              {item.jenjang_pendidikan || "Belum diisi"}
                            </span>
                          </div>
                          <div className="detail-item">
                            <span className="detail-icon">📅</span>
        ...
        <div className="overview-card kelompok">
          ...
          <div className="overview-content">
            <h3 className="overview-value">
              {Object.keys(kelompokStats).length}
            </h3>
      ...
      <div className="kelompok-section">
        ...
        {Object.keys(kelompokStats).length === 0 ? (
          <div className="empty-state">
            ...
            <p className="empty-subtext">
              Data kelompok akan muncul di sini setelah data generus ditambahkan
            </p>
          </div>
        ) : (
                ...
                <div className="kelompok-stats">
                  <div className="kelompok-stat">
                    ...
                    <span className="stat-value">
                      {stats.gender["Laki-laki"] || 0}
                    </span>
                  </div>
                  <div className="kelompok-stat">
                    <span className="stat-label">👧 Perempuan:</span>
                    <span className="stat-value">
                      {stats.gender["Perempuan"] || 0}
                    </span>
                  </div>
                  <div className="kelompok-stat">
                    <span className="stat-label">📚 Jenjang:</span>
                    <span className="stat-value">
                      {Object.keys(stats.pembinaan).length}
                    </span>
                  </div>
                </div>

                <button className="kelompok-button">📋 Lihat Detail</button>
              </div>
            ))}
          </div>
        )}
      ...
      {showModal && selectedKelompok && (
        <div className="modal-overlay" onClick={closeModal}>
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            <div className="modal-header">
              <h2 className="modal-title">
                📊 Detail Kelompok - {selectedKelompok}
              </h2>
              <div className="modal-actions">
                <button
                  className="export-btn small"
              ...
              <div className="modal-statistics">
                ...
                <div className="statistics-grid modal-grid">
                  ...
                  >
                    ...
                    <div className="stat-content">
                      <h3 className="stat-value">
                        {kelompokStats[selectedKelompok].total}
                      </h3>
                      <p className="stat-label">Total Generus</p>
                      <button
                        className="export-mini-btn"
                  ...
                  <div className="stat-card gender">
                    ...
                    <div className="stat-content">
                      <h3 className="stat-value">
                        {(kelompokStats[selectedKelompok].gender["Laki-laki"] ||
                          0) +
                          (kelompokStats[selectedKelompok].gender[
                            "Perempuan"
                          ] || 0)}
                      </h3>
                      <p className="stat-label">Jenis Kelamin</p>
                  ...
                  <div className="stat-card pembinaan">
                    ...
                    <div className="stat-content">
                      <h3 className="stat-value">
                        {
                          Object.keys(kelompokStats[selectedKelompok].pembinaan)
                            .length
                        }
                      </h3>
                      <p className="stat-label">Jenjang Pembinaan</p>
                      <div className="stat-details">
                        {Object.entries(
                          kelompokStats[selectedKelompok].pembinaan
                        ).map(([key, value]) => (
                          <div
                            key={key}
                            className="stat-detail-row clickable"
                  ...
                  <div className="stat-card pendidikan">
                    ...
                    <div className="stat-content">
                      <h3 className="stat-value">
                        {
                          Object.keys(
                            kelompokStats[selectedKelompok].pendidikan
                          ).length
                        }
                      </h3>
                      <p className="stat-label">Jenjang Pendidikan</p>
                        ...
                        {Object.entries(
                          ...
                          >
                            ...
                            <button
                              ...
                              onClick={(e) => {
                                e.stopPropagation();
                                const categories = pendidikanCategories[
                                  key
                                ] || [key];
                                const filtered = kelompokStats[
                                  selectedKelompok
                                ].generusList.filter((item) => {
                                  const pendidikan = cleanPendidikanData(
                                    item.jenjang_pendidikan
                                  );
                                  return categories.includes(pendidikan);
